# NixOS Configuration Template for Framework 16 Development Environment
# Base template - add hardware imports and bootloader config during installation
# Based on Framework 16 Virtualization Strategy Recommendation

{ config, pkgs, ... }:

{
  # NOTE: During installation, you must add:
  # 1. Import hardware-configuration.nix (generated by nixos-generate-config)
  # 2. Bootloader configuration for QEMU VM
  #
  # See configuration.nix for the complete working version
