...
## Project Identity
**Name**: **Clutchscape** (Browser) / **Basin** (Kernel)  
**Est.** 2025  
...
**Objective**: Begin the implementation of **Basin**, a RISC-V targeted operating system kernel written from scratch in Zig, and **Clutchscape**, a native browser interface running on top of it.
