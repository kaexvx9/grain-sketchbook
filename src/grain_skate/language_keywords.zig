...
pub const LanguageKeywords = struct {
    ...
    /// Why: Required for syntax highlighting by identifying language keywords.
    ...
    fn is_zig_keyword(word: []const u8) bool {
        const keywords = [_][]const u8{
            "if", "else", "while", "for", "fn", "var", "const", "return",
            "break", "continue", "pub", "priv", "struct", "enum", "union",
            "error", "try", "catch", "defer", "switch", "case", "default",
            "true", "false", "null", "undefined", "void", "bool", "u8", "u16",
            "u32", "u64", "i8", "i16", "i32", "i64", "f32", "f64", "usize",
            "isize", "comptime", "inline", "noinline", "export", "extern",
            "packed", "align", "test", "async", "await", "suspend", "resume",
            "anytype", "anyframe", "allowzero", "volatile", "linksection",
            "callconv", "nakedcc", "stdcallcc", "asm", "usingnamespace",
        };
    ...
    fn is_javascript_keyword(word: []const u8) bool {
        const keywords = [_][]const u8{
            ...
            "void", "volatile", "while", "with", "yield", "async", "await", "from",
            "of", "as", "type", "namespace", "declare", "module", "interface", "enum",
            "const", "readonly", "keyof", "infer", "extends", "implements",
        };
        for (keywords) |keyword| {
            if (word.len == keyword.len and std.mem.eql(u8, word, keyword)) {
                return true;
    ...
    fn is_html_keyword(word: []const u8) bool {
        const keywords = [_][]const u8{
            ...
            "textarea", "select", "option", "br", "hr", "strong", "em", "b", "i",
            "u", "code", "pre", "blockquote", "article", "section", "nav", "header",
            "footer", "aside", "main",
        };
        for (keywords) |keyword| {
            if (word.len == keyword.len and std.mem.eql(u8, word, keyword)) {
    ...
    fn is_css_keyword(word: []const u8) bool {
        const keywords = [_][]const u8{
            ...
            "float", "font", "font-family", "font-kerning", "font-size",
            "font-stretch", "font-style", "font-variant", "font-weight", "grid",
            "grid-area", "grid-auto-columns", "grid-auto-flow", "grid-auto-rows",
            "grid-column", "grid-column-end", "grid-column-gap", "grid-column-start",
            "grid-gap", "grid-row", "grid-row-end", "grid-row-gap", "grid-row-start",
            "grid-template", "grid-template-areas", "grid-template-columns",
            "grid-template-rows", "hanging-punctuation", "height", "hyphens",
            "isolation", "justify-content", "left", "letter-spacing", "line-height",
