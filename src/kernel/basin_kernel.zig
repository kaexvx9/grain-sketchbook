...
pub fn handle_syscall(
    ...
    fn syscall_sysinfo(
        ...
        // Use saturating subtract to prevent underflow if allocated_pages > MAX_PAGES
        const available_pages: u32 = if (allocated_pages > MAX_PAGES) 0 else MAX_PAGES - allocated_pages;
